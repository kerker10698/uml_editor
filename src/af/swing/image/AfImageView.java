...
public class AfImageView extends JPanel
{
	...
	//private Image image;
	ImageHandlerInterface imageShowedHdr;
	...
	public AfImageView()
	{
		...
		imageShowedHdr = new ImageHandler();
	}

	
	public ImageHandlerInterface getImage()
	{
		return imageShowedHdr;
	}

	public void setImage(ImageHandlerInterface setImageShowedHdr)
	{
		this.imageShowedHdr = setImageShowedHdr;
		repaint();
	}
	...
	protected void paintComponent(Graphics g)
	{
		...
		/////////////////////////
		if(imageShowedHdr.getImage() != null)
		{
			int imgW = imageShowedHdr.getImage().getWidth(null);
			int imgH = imageShowedHdr.getImage().getHeight(null);
			...
			// 绘制
			g.drawImage(imageShowedHdr.getImage(), fit.x, fit.y, fit.width, fit.height,	null);
		}
	}
