...
public class AssociationLineMode extends Mode{
	...
	public AssociationLineMode(String use, String imagePathNormal, String imagePathOn, int p, ModeListInterface _f)
	{
	...
	public void released(MouseEvent e) {
		...
		if(pressBase != null && releaseBase != null)
		{
			...
			{
				Line line = new AssociationLine(pressBase, releaseBase, pressPort, releasePort);
				this.add(line);
